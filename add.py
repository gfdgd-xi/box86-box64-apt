...
<p><b>下载链接：<a href='http://deb.box86.wine-runner.gfdgdxi.top//{debInfo[2][0].lower()}/{debInfo[2]}/{debInfo[2]}_{debInfo[1]}_{debInfo[0]}.deb'>http://deb.box86.wine-runner.gfdgdxi.top/{debInfo[2][0].lower()}/{debInfo[2]}/{debInfo[2]}_{debInfo[1]}_{debInfo[0]}.deb</a></b></p>
...
<body>
    ...
    <h3>推荐直接添加该源，添加方法：</h3>
    <pre><code>
wget http://deb.box86.wine-runner.gfdgdxi.top/sources/github.sh; bash github.sh; rm github.sh
</code></pre>
